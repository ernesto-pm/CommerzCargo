...
@section('content')
    <header>
        <div class="header-content">
            ...
            <img style="width:25%;margin: 0 auto;" class="img-responsive" src="{{ URL::asset('login/logo.png') }}">
            <br>
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                        <div class="panel panel-default panelCommerz">
                            <div class="panel-heading">
                                <h3 class="panel-title">- Inicia Sesión Conductor <small>Ingresa a tu cuenta</small> -</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                ¿No tienes una cuenta? Registrate <a href="{{ route('carriers.create') }}"> Aquí</a>
                            </div>
                        </div>
                    </div>
                </div>
